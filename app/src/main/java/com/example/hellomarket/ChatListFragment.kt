...
import com.example.hellomarket.databinding.FragmentChatlistBinding
...
class ChatListFragment:Fragment(R.layout.fragment_chatlist) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        chatDB = Firebase.database.reference.child(DB_USERS).child(auth.currentUser!!.email?.replace(".", "_") ?: "").child(CHILD_CHAT)
